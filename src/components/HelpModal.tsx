...
export function HelpModal({
  ...
  return (
    ...
    >
      ...
      />
      <div className="glass-sheet relative w-full sm:max-w-md max-h-[85dvh] overflow-y-auto rounded-t-2xl sm:rounded-2xl border border-chess-hairline-strong bg-chess-panel shadow-elev-4 p-5 sm:p-6 pb-[max(1.25rem,env(safe-area-inset-bottom,0px))] sm:pb-6">

  ...
  return (
    <>
      ...
      <div className="relative lg:hidden">
        ...
        {showDepthMenu && (
          <div className="absolute right-0 top-[calc(100%+0.4rem)] z-[90] flex gap-0.5 rounded-xl border border-chess-hairline-strong bg-chess-panel p-1.5 shadow-elev-4">
            {depths.map((d) => (
              <button
                key={d}
                type="button"
